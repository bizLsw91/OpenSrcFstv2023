...
export const speakersData = {
    example: {
        ...
        company: '',
        position: '',
        imgUrl: 'https://open-src-fstv-2024.vercel.app//assets/img/speakers/유태희.jpg',
    ...
    startLect: {
        1: {
            ...
            company: '서울대학교',
            position: '교수',
            imgUrl: 'https://open-src-fstv-2024.vercel.app//assets/img/speakers/장혜식.jpg',
            docFilePath: 'speakersDoc/2024/기조강연 01_장혜식 교수.pdf',
        ...
        2: {
            ...
            company: '현대자동차',
            position: '책임연구원',
            imgUrl: 'https://open-src-fstv-2024.vercel.app//assets/img/speakers/백송하.png',
            docFilePath: '',
    ...
    lectures: {
        1: {
            ...
            company: '리벨리온',
            position: '총괄',
            imgUrl: 'https://open-src-fstv-2024.vercel.app//assets/img/speakers/김홍석.jpg',
            docFilePath: '',
        ...
        2: {
            ...
            position: '대표',
            imgUrl: 'https://open-src-fstv-2024.vercel.app//assets/img/speakers/조성수.png',
            docFilePath: 'speakersDoc/2024/04. 강연_조성수 대표.pdf',
        ...
        3: {
            ...
            company: '래블업㈜',
            position: '대표',
            imgUrl: 'https://open-src-fstv-2024.vercel.app//assets/img/speakers/신정규.jpg',
            docFilePath: 'speakersDoc/2024/05. 강연_신정규 대표.pdf',
        ...
        4: {
            ...
            company: '젝사젠㈜',
            position: '대표',
            imgUrl: 'https://open-src-fstv-2024.vercel.app//assets/img/speakers/박문식.jpg',
            docFilePath: 'speakersDoc/2024/06. 강연_박문식 대표.pdf',
        ...
        5: {
            ...
            position: '연구원',
            imgUrl: 'https://open-src-fstv-2024.vercel.app//assets/img/speakers/이현정.png',
            docFilePath: 'speakersDoc/2024/07. 강연_이현정 연구원.pdf',
        ...
        6: {
            ...
            company: '㈜무아베모션',
            position: '대표',
            imgUrl: 'https://open-src-fstv-2024.vercel.app//assets/img/speakers/오재웅.jpg',
    ...
    poster: {
        1: {
            ...
            position: '',
            imgUrl: 'https://open-src-fstv-2024.vercel.app//assets/img/speakers/박병철.jpg',
            profileList: ['약력1','약력2','약력3'],
            profileDesc: '',
            subject:'Semantic Kernel로 다양한 LLM을 하나로 오케스트레이션하기',
            docFilePath: 'speakersDoc/2024/01. 발표_유저스틴.pdf',
        },
        2:{
            badge: '발표-2',
            name: '김진섭',
            company: 'Shinykorea',
            position: '',
            imgUrl: 'https://open-src-fstv-2024.vercel.app//assets/img/speakers/김진섭.jpg',
            profileList: ['약력1','약력2','약력3'],
            profileDesc: '',
            subject:'의학연구를 위한 오픈소스 R 통계패키지 소개',
            docFilePath: 'speakersDoc/2024/02. 발표_김진섭.pdf',
        },
        3:{
            badge: '발표-3',
            name: '장동욱',
            ...
            position: '',
            imgUrl: 'https://open-src-fstv-2024.vercel.app//assets/img/speakers/장동욱.jpg',
            profileList: ['약력1','약력2','약력3'],
            profileDesc: '',
            subject:'실시간으로 데이터를 복제',
            docFilePath: 'speakersDoc/2024/03. 발표_장동욱.pdf',
        },
        4:{
            badge: '발표-4',
            name: '차불휘',
            company: '린(Lean)',
            position: '',
            imgUrl: 'https://open-src-fstv-2024.vercel.app//assets/img/speakers/차불휘.jpg',
            profileList: ['약력1','약력2','약력3'],
            profileDesc: '',
            subject:'린 정리 증명기의 소개 및 활용',
            docFilePath: 'speakersDoc/2024/04. 발표_차불휘.pdf',
        },
        5:{
            badge: '발표-5',
            name: '허광남',
            company: 'okdevtv',
            position: '',
            imgUrl: 'https://open-src-fstv-2024.vercel.app//assets/img/speakers/허광남.jpg',
            profileList: ['약력1','약력2','약력3'],
            profileDesc: '',
            subject:'표준프레임워크 MSA edu 프로젝트 스터디 회고',
            docFilePath: 'speakersDoc/2024/05. 발표_허광남.pdf',
        },
        6:{
            badge: '발표-6',
            name: '정이태',
            ...
            position: '',
            imgUrl: 'https://open-src-fstv-2024.vercel.app//assets/img/speakers/정이태.jpg',
            profileList: ['약력1','약력2','약력3'],
            profileDesc: '',
            subject:'커뮤니티를 활용해 그래프 기술을 전달하는 방식',
            docFilePath: 'speakersDoc/2024/06. 발표_정이태.pdf',
        },
        7:{
            badge: '발표-7',
            name: '안이수',
            company: 'Debian',
            position: '',
            imgUrl: 'https://open-src-fstv-2024.vercel.app//assets/img/speakers/안이수.jpg',
            profileList: ['약력1','약력2','약력3'],
            profileDesc: '',
        ...
        8:{
            ...
            position: '',
            imgUrl: 'https://open-src-fstv-2024.vercel.app//assets/img/speakers/이제응.jpg',
            profileList: ['약력1','약력2','약력3'],
            profileDesc: '',
            subject:'클라우드 네이티브와 AI 생태계진화',
            docFilePath: 'speakersDoc/2024/08. 발표_이제응.pdf',
        },
        9:{
            badge: '발표-9',
            name: '김관영',
            ...
            position: '',
            imgUrl: 'https://open-src-fstv-2024.vercel.app//assets/img/speakers/김관영.jpg',
            profileList: ['약력1','약력2','약력3'],
            profileDesc: '',
            subject:'일상속에 클라우드, 오픈스택',
            docFilePath: 'speakersDoc/2024/09. 발표_김관영.pdf',
        },
    }
}